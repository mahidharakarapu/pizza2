...
create table inventory(productID integer not null,
productName varchar(200) not null,
quantity integer not null,
primary key(productID));

insert into inventory values(15,'sauce',100);
insert into inventory values(16,'flour',100);

create table undelivered_orders(orderID integer not null,
